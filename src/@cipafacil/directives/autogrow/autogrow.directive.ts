...
@Directive({
    selector: 'textarea[cipafacilAutogrow]',
    exportAs: 'cipafacilAutogrow'
})
export class CipaFacilAutogrowDirective implements OnChanges, OnInit, OnDestroy
{
    // tslint:disable-next-line:no-input-rename
    @Input('cipafacilAutogrowVerticalPadding') padding: number = 8;
    ...
    {
        // Padding
        if ( 'cipafacilAutogrowVerticalPadding' in changes )
        {
            // Resize
            this._resize();
        }
