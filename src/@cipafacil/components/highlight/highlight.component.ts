...
import { CipaFacilHighlightService } from '@cipafacil/components/highlight/highlight.service';

@Component({
    selector       : 'textarea[cipafacil-highlight]',
    templateUrl    : './highlight.component.html',
    styleUrls      : ['./highlight.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'cipafacilHighlight'
})
export class CipaFacilHighlightComponent implements OnChanges, AfterViewInit
{
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _cipafacilHighlightService: CipaFacilHighlightService,
    ...
    private _highlightAndInsert(): void
    {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._cipafacilHighlightService.highlight(this.code, this.lang));
