...
@Component({
    selector     : 'cipafacil-date-range',
    templateUrl  : './date-range.component.html',
    styleUrls    : ['./date-range.component.scss'],
    encapsulation: ViewEncapsulation.None,
    exportAs     : 'cipafacilDateRange',
    providers    : [
        {
            provide    : NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => CipaFacilDateRangeComponent),
            multi      : true
        }
    ]
})
export class CipaFacilDateRangeComponent implements ControlValueAccessor, OnInit, OnDestroy
{
    ...
    @HostBinding('class.cipafacil-date-range') private _defaultClassNames = true;
    ...
    openPickerPanel(): void
    {
        ...
        const overlayRef = this._overlay.create({
            panelClass      : 'cipafacil-date-range-panel',
            backdropClass   : '',
            hasBackdrop     : true,
    ...
    dateClass(): any
    {
        return (date: Moment): MatCalendarCellCssClasses => {
            ...
            {
                return ['cipafacil-date-range', 'cipafacil-date-range-start', 'cipafacil-date-range-end'];
            }

            // If the date is the start date...
            if ( date.isSame(this._range.start, 'day') )
            {
                return ['cipafacil-date-range', 'cipafacil-date-range-start'];
            }

            // If the date is the end date...
            if ( date.isSame(this._range.end, 'day') )
            {
                return ['cipafacil-date-range', 'cipafacil-date-range-end'];
            }

            // If the date is in between start and end dates...
            if ( date.isBetween(this._range.start, this._range.end, 'day') )
            {
                return ['cipafacil-date-range', 'cipafacil-date-range-mid'];
            }
