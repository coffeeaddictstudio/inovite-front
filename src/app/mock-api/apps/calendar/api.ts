...
import { CipaFacilMockApiService, CipaFacilMockApiUtils } from '@inovite/lib/mock-api';
    ...
    registerHandlers(): void
    {
        ...
        this._cipafacilMockApiService
            ...
            .reply(({request}) => {
                ...
                newCalendar.id = CipaFacilMockApiUtils.guid();
        ...
        this._cipafacilMockApiService
            ...
            .reply(({request}) => {
                ...
                newEvent.id = CipaFacilMockApiUtils.guid();
