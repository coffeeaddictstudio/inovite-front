...
import { CipaFacilMockApiUtils } from '@inovite/lib/mock-api/mock-api.utils';
import { CipaFacilMockApiService } from '@inovite/lib/mock-api/mock-api.service';
    ...
    registerHandlers(): void
    {
        ...
        this._cipafacilMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newTag.id = CipaFacilMockApiUtils.guid();
