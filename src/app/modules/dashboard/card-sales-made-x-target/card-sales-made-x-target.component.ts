...
@Component({
    selector: 'dashboard-card-sales-made-x-target',
    templateUrl: './card-sales-made-x-target.component.html',
    styleUrls: ['./card-sales-made-x-target.component.scss'],
    encapsulation: ViewEncapsulation.None,
    providers: [DatePipe, CurrencyBRL]
})
export class DashboardCardSalesMadeXTargetComponent implements OnInit
{
    chart: ApexOptions;
    ...
    public data = [
        { name: 'Osmar', percentage: 111 },
        { name: 'Valéria', percentage: 107 },
        { name: 'Luis F.', percentage: 106 },
        { name: 'Francisco', percentage: 104 },
        { name: 'Carlos', percentage: 102 },
        { name: 'Euclides', percentage: 100 },
        { name: 'Gabriel', percentage: 97 },
        { name: 'Leonardo', percentage: 96 },
        { name: 'Deleon', percentage: 94 },
        { name: 'Driele', percentage: 91 },
        { name: 'Pedro', percentage: 67 },
    ];
