...
@Component({
    selector: 'dashboard-card-volume-billing',
    templateUrl: './card-volume-billing.component.html',
    styleUrls: ['./card-volume-billing.component.scss'],
    providers: [CurrencyBRL],
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class DashboardCardVolumeBillingComponent implements OnInit
{
