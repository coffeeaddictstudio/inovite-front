...
@Component({
    selector: 'dashboard-card-amount-realized-x-goal',
    templateUrl: './card-amount-realized-x-goal.component.html',
    styleUrls: ['./card-amount-realized-x-goal.component.scss'],
    encapsulation: ViewEncapsulation.None,
    providers: [DatePipe, CurrencyBRL]
})
export class DashboardCardAmountRealizedXGoalComponent implements OnInit
{
    chart: ApexOptions;
