...
@Component({
    selector: 'dashboard-card-budget-share',
    templateUrl: './card-budget-share.component.html',
    styleUrls: ['./card-budget-share.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class DashboardCardBudgetShareComponent implements OnInit
{
