...
@Component({
    selector: 'dashboard-card-evolution-regional',
    templateUrl: './card-evolution-regional.component.html',
    styleUrls: ['./card-evolution-regional.component.scss'],
    encapsulation: ViewEncapsulation.None,
    providers: [DatePipe, CurrencyBRL]
})
export class DashboardCardEvolutionRegionalComponent implements OnInit {
    chart: ApexOptions;
    months: number = 3;
